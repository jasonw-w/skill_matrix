...
import { onRequestDelete as __api_admin_workstations_js_onRequestDelete } from "C:\\Users\\User\\Documents\\Project\\skill_matrix\\functions\\api\\admin\\workstations.js"
...
export const routes = [
    ...
    },
  {
      ...
      method: "DELETE",
      middlewares: [],
      modules: [__api_admin_workstations_js_onRequestDelete],
    },
  {
      routePath: "/api/admin/workstations",
      mountPath: "/api/admin",
